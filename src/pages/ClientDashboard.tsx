    ...
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Nível de Força (Novidade) */}
          <Card className="bg-card/50 backdrop-blur-md border-border border-l-4 border-l-red-500 shadow-xl">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Nível de Força</CardTitle>
              <Trophy className="h-4 w-4 text-red-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-foreground truncate">{strengthLoading ? '...' : overallLevel}</div>
              <p className="text-xs text-muted-foreground mt-1">Estimado (Powerlifting)</p>
            </CardContent>
          </Card>

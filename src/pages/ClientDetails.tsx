...
const ClientDetails: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-4 md:py-8 w-full">
      <div className="w-full px-4 md:max-w-7xl md:mx-auto md:px-8">
        ...
        {/* Container que garante scroll APENAS nas abas, não na página */}
        <Tabs defaultValue="dashboard" className="space-y-6 w-full">
          ...
          <TabsContent value="dashboard" className="animate-in fade-in slide-in-from-left-2 duration-500 space-y-6">
            {/* Grid que muda de 1 coluna (mobile) para 3 colunas (desktop) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
              ...
              <Card className="lg:col-span-2 bg-gradient-to-br from-slate-900 to-slate-950 border-white/10 shadow-xl relative overflow-hidden w-full">
                ...
                <CardContent className="pt-6 px-4 md:px-8 pb-6">
                  {/* Flex-col no mobile (vertical) -> Flex-row no desktop */}
                  <div className="flex flex-col md:flex-row gap-6 items-center md:items-start w-full">
                    ...
                    {/* min-w-0 é a CHAVE para impedir que o flex item estoure o container */}
                    <div className="flex-1 min-w-0 w-full text-center md:text-left">
                      <h2 className="text-2xl font-bold text-white mb-1 truncate w-full">{clientProfile?.full_name}</h2>
              ...
              <Card className="bg-white/5 border-white/10 w-full">
                ...
                <CardContent className="p-4 pt-0 grid grid-cols-2 gap-3">
                  <Button variant="outline" className="h-auto py-4 flex-col border-white/10 bg-white/5 hover:bg-white/10 text-white gap-1.5" onClick={() => setIsAssignWorkoutOpen(true)}><Dumbbell className="h-5 w-5 text-blue-400"/> <span className="text-xs">Treino</span></Button>
                  <Button variant="outline" className="h-auto py-4 flex-col border-white/10 bg-white/5 hover:bg-white/10 text-white gap-1.5" onClick={() => setIsAssignMealPlanOpen(true)}><Utensils className="h-5 w-5 text-orange-400"/> <span className="text-xs">Dieta</span></Button>
                  <Button variant="outline" className="h-auto py-4 flex-col border-white/10 bg-white/5 hover:bg-white/10 text-white gap-1.5" onClick={openNewAssessment}><Scale className="h-5 w-5 text-green-400"/> <span className="text-xs">Avaliar</span></Button>
                  <Button variant="outline" className="h-auto py-4 flex-col border-white/10 bg-white/5 hover:bg-white/10 text-white gap-1.5" onClick={() => navigate('/app/chat')}><MessageSquare className="h-5 w-5 text-purple-400"/> <span className="text-xs">Chat</span></Button>
                </CardContent>
              </Card>

              {/* 3. MÉTRICAS (1 col mobile -> 2 col md -> 4 col lg) */}
              <Card className="bg-white/5 border-white/10 lg:col-span-3 w-full">
                ...
                <CardContent className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-black/20 p-4 rounded-lg border border-white/5 flex justify-between items-center md:block">
                    <p className="text-gray-400 text-[10px] uppercase tracking-wider md:mb-1">Peso</p>

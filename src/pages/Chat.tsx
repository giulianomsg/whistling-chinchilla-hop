...
// Componente separado para a lista de contatos
const ContactsList: React.FC<{
  contacts: ClientProfessional[]
  selectedUser: Profile | null
  searchTerm: string
  profile: Profile | null
  unreadCounts: UnreadCount
  onSelectUser: (contact: ClientProfessional) => void
  isMobile: boolean
}> = ({ contacts, selectedUser, searchTerm, profile, unreadCounts, onSelectUser, isMobile }) => {
...
// Componente separado para a área do chat
  ...
  const fetchContacts = async () => {
    ...
    try {
      ...
      if (profile.role === 'professional') {
        ...
        // Cliente busca seus profissionais - CORREÇÃO APLICADA AQUI
        query = supabase
          .from('client_professionals')
          .select(`
            *,
